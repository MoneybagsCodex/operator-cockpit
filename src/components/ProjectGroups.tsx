...
import { FolderKanban, Trash2, ChevronDown } from 'lucide-react';
...
export function ProjectGroups({ groups, liveCounts, onLaunch, onDelete, collapsed, onToggleCollapsed }: ProjectGroupsProps) {
